...
HOME:      %s""" % (settings["ROOT"], settings["EFI"],
    ...
    <b>SYSTEM</b>
        """)
            ...
            self.grid.attach(label12, 4, 5, 1, 1)
    ...
    <b>USER</b>
        """)
            ...
            self.grid.attach(label24, 6, 5, 1, 1)
    ...
    <b>OTHER</b>
        ...
        self.grid.attach(button1, 8, 8, 1, 1)
